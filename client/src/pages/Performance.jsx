...
function EmptyChart() {
  return (
    <div className="flex h-[300px] items-center justify-center rounded-md border border-gray-200 bg-gray-50 p-6 text-center">
    ...
    return (
      <div className="bg-gray-50 px-4 py-12 text-gray-900">
        <div className="mx-auto w-full max-w-5xl rounded-md border border-gray-200 bg-white p-8 text-center">
          <BarChart3 className="mx-auto h-10 w-10 text-blue-600" aria-hidden="true" />
                      ...
                      >
                        ...
                        <td className="py-4 text-right">
                          <Link
                            ...
                            className="inline-flex items-center justify-center rounded-md border border-gray-300 p-2 text-blue-700 transition hover:border-blue-500 hover:bg-gray-100 hover:text-blue-800"
                          >
